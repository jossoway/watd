...
<script>
// this little bit of jQuery duplicates the username to the hidden name field.
jQuery(document).ready(function(){
$("div#profile-details-section").addClass("displaynone");
$('#basic-details-section input#signup_username').bind('keyup keypress blur', function()
 {
    $('#profile-details-section input#field_1').val($(this).val());
});
});
</script>
